...
public class HeroMotor : MonoBehaviour
{
    ...
    private void HandleStateChanged(HeroState oldState, HeroState newState)
    {
        ...
        {
            // На драбині гравітація не повинна тягнути героя вниз.
            rb.gravityScale = 0f;

            // При вході в драбину прибираємо стару інерцію,
            // щоб не було ривків від попереднього стану.
        ...
        // Це прибирає підскок над верхнім краєм.
