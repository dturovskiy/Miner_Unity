...
1. `PlayButton` усе ще поєднує `New Game` reset і scene navigation
2. diagnostics усе ще шумні через часті `Heartbeat`
3. у ранніх hero-логах ще видно readiness-era дублювання полів

Тобто структура тек уже стала чистішою, але `Stage 0` ще не можна вважати формально завершеним.
